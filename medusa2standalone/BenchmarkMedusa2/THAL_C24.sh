...
#C24
title="2 - C24 Mummer"
input='/home/desk/PycharmProjects/medusa3/datasets_medusa/THAL/C24/C24.chr.all.v2.0.fasta.fna'
reference='/home/desk/PycharmProjects/medusa3/datasets_medusa/THAL/reference_genomes_NOC24/'
output='outputTHAL-C24INPUT'
mapping='/home/desk/PycharmProjects/medusa3/BenchmarkMedusa3/MappingTHAL/C24.mapping'
for i in $(seq 1 0)
do
	echo $title
	...
	bash pipe_testing_benchmark.sh ../scripts/$output/scaffolds.fasta $input $mapping >> C24_mummer.log
...
# mm2
title="2 - C24 Minimap2"
input='/home/desk/PycharmProjects/medusa3/datasets_medusa/THAL/C24/C24.chr.all.v2.0.fasta.fna'
reference='/home/desk/PycharmProjects/medusa3/datasets_medusa/THAL/reference_genomes_NOC24/'
output='outputTHAL-C24INPUT_MM2'
mapping='/home/desk/PycharmProjects/medusa3/BenchmarkMedusa3/MappingTHAL/C24.mapping'
for i in $(seq 1 3)
do
	echo $title
	...
	cd "/home/desk/PycharmProjects/medusa3/medusa_testing/"
	bash pipe_testing_benchmark.sh ../scripts/$output/scaffolds.fasta $input $mapping >> C24_minimap2.log
	#mv /home/desk/PycharmProjects/medusa3/scripts/$output/scaffolds.fasta /home/desk/PycharmProjects/medusa3/scripts/$output/scaffolds_$i.fasta
done
